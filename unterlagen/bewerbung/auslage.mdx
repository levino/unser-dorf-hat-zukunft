...
<div className={styles.embeddedPdf}>
  <embed src="/bebauungsplaene/5094_1001_LangeWanne.pdf" />
</div>
<div className={styles.embeddedPdf}>
  <embed src="/bebauungsplaene/5094_1003_Clausstrasse.pdf" />
</div>
<div className={styles.embeddedPdf}>
  <embed src="/bebauungsplaene/5094_1006_Marsch.pdf" />
</div>
<div className={styles.embeddedPdf}>
  <embed src="/bebauungsplaene/5094_1005_HinterDerClausstrasse.pdf" />
</div>
<div className={styles.embeddedPdf}>
  <embed src="/bebauungsplaene/5094_1008_AnDerClausstrasse.pdf" />
</div>
<div className={styles.embeddedPdf}>
  <embed src="/bebauungsplaene/5094_1009_HinterDenBuchen.pdf" />
</div>
<div className={styles.embeddedPdf}>
  <embed src="/bebauungsplaene/5094_1010_Clausstraße_West.pdf" />
</div>

## ggf. Dorferneuerungsplan

<div className={styles.embeddedPdf}>
  <embed src="/Dorferneuerungsplan.pdf" />
</div>
